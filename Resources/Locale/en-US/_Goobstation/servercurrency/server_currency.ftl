...
server-currency-name-singular = Immernacht Coin
server-currency-name-plural = Immernacht Coins
...
gs-balanceui-shop-buy-token-antag = Buy an Antag Token - {$price} Immernacht Coins
gs-balanceui-shop-buy-token-admin-abuse = Buy an Admin Abuse Token - {$price} Immernacht Coins
gs-balanceui-shop-buy-token-hat = Buy a Hat Token - {$price} Immernacht Coins
